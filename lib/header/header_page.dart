  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        AutoSizeText(
          //"Hi",
          "Hi! My name is Osama Ilyas and I'm currently a Graduate Developer. I have always had an interest in technology, and this lead me to Cardiff University to pursue that passion. Since graduating from university, I have been working on different projects ranging from websites to mobile apps to games, which has been a challenge, but it has allowed me to improve my skill set! I have also worked with many different clients during my time at University, so I have an excellent knowledge on how to conduct sprint meetings and working under agile methodologies. You can find more information about me by looking at my CV down below and I looking forward to getting in touch with you soon.",
        ...
        FilledButton(
          ...
          onPressed: () => launchUrlString(
              'https://drive.google.com/file/d/1IVbuUPeX6UheWXhy4G2f-1kR_29_n04t/view?usp=sharing'),
          child: Padding(
            padding: EdgeInsets.symmetric(
